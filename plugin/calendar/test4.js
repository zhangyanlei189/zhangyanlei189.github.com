...
$("#re-sel").on("click",function () {
    var stNode = "[2018-08-02至2018-08-04][2018-08-17至2018-08-17][2018-08-30至2018-08-30][2018-09-20至2018-09-20][2018-09-26至2018-09-27][2018-10-30至2018-10-30]";
    var resAll = reformatDate(stNode);
    console.log(resAll);
});
...
function reformatDate(s){
    ...
    var allArr = {},child=[],oldMonth=0,oldYear=0;
        ...
        if(start) {
            ...
            for (var j = start; j <= end; j = j + 86400000) {
                ...
                if(oldYear != year ||oldMonth != month){
                    ...
                    oldMonth = month;
                    child = [];
                    child.push(year + "-" + month + "-" + day);
                    allArr[year+"-"+month] = child;
                }else {
                    child.push(year + "-" + month + "-" + day);
                }
            }
