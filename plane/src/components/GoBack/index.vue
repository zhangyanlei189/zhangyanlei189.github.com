        ...
        <div class="c-cont">
            <form action="#">
                ...
                <div class="cell clearfix">
                    <div class="date-sel fl"><div>04月18日<span>明天</span></div></div>
                    <div class="date-sel fr"><div style="display: none;">04月18日<span>明天</span></div><div class="fr res-date">返程日期</div></div>
                </div>
                <div class="cell clearfix">
...
<script>
    ...
    export default {
        name: "goBack",
        components: {
            CityList,SelClass,SelPassenger
        },
        data(){
            return {
                setCityShow:false,
